      ...
      <div className="mt-10 rounded-[28px] border border-white/[0.09] bg-white/[0.025] p-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_24px_64px_-24px_rgba(0,0,0,0.6)]">
        <div className="rounded-[calc(28px-0.375rem)] border border-white/[0.05] bg-gradient-to-b from-white/[0.025] to-transparent p-7 sm:p-9">
          ...
          >
            ...
            {error && <p role="alert" className="rounded-xl border border-red-400/30 bg-red-400/10 p-3 text-sm text-red-100">{error}</p>}
          ...
          <button
            ...
            className="glass-ghost metal-shine group flex h-12 w-full items-center justify-center gap-3 rounded-full text-[14px] font-medium text-white outline-none transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] active:scale-[0.98]"
          >
